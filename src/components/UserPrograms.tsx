      ...
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="bg-card/90 backdrop-blur-sm border border-border rounded-lg overflow-hidden mb-16">
          ...
          <div className="p-8 text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              ...
              <span className="text-primary">Wellness Plans</span>
            </h2>

            <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-10">
              Discover personalized mental wellness strategies and fitness
              routines crafted by our AI assistant, tailored to support your
          ...
          {USER_PROGRAMS.map((program) => (
            ...
            >
              ...
              <CardContent className="px-5">
                ...
                <div className="space-y-5 pt-2">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-center">
                        <h3 className="font-medium text-foreground">
                          {program.mental_health_plan.title}
                        </h3>
                      </div>
                      <p className="text-sm text-muted-foreground mt-1">
                        {program.mental_health_plan.focus_area}
                      </p>
                    </div>
                  </div>
                ...
                {/* Program description - Now displays Mental Health description */}
                <div className="mt-5 pt-5 border-t border-border">
                  <div className="text-sm text-muted-foreground">
                    <span className="text-purple-500">&gt; </span>
                    {program.mental_health_plan.description.substring(0, 120)}...
                  </div>
                </div>
              </CardContent>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-muted-foreground mt-4">
            Join 500+ users with AI-customized wellness programs
          </p>
        </div>
      </div>
    </div>
